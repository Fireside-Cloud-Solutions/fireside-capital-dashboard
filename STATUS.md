...
|-------|-------|------|--------|
| Builder | builder-mobile-critical-fixes | Fix 4 critical mobile responsiveness issues (charts rendering, table scroll, button wrapping, sidebar overlay) | 🔄 Running (est. 5 hours) |
