...
**Owner:** Matt Hubacher  
**Last Updated:** 2026-02-17 05:35 EST (Sprint Research 0535: 8 new tasks created — FC-180 to FC-187 — Budget vs Actuals engine + Demo Mode architecture)
...
| FC-187 | Feature | P2 | XS | Ready | **Demo Mode Toggle in Settings** — Add "Demo Mode" toggle in Settings page under Display Preferences. Shows/hides sample data system-wide. (30 min) — Sprint Research 2026-02-17 |### EPIC-002: Mobile Application
